(function(pluginName){
    ...
    CKEditorPluginUtility.Plugins[pluginName].GetHtmlTemplate=function(tipMsg,addDefProp) {
        ...
        var template=`<div class="wysiwyg-wldct-list-simple-search-outer-wrap wldct-list-simple-search-outer-wrap">${tip}<div class="wysiwyg-wldct-list-simple-search-inner-wrap wldct-list-simple-search-inner-wrap">
                               <table>
                                   <colgroup>
                                       <col style="width: 8%" />
                                       <col style="width: 17%" />
        ...
        if(addDefProp){
            ...
            template.attr("desc","");
            template.attr("id","list_s_search_wrap_788954467");
            template.attr("is_jbuild4dc_data","false");
            template.attr("jbuild4dc_custom","true");
            template.attr("name","list_s_search_wrap_788954467");
        ...
        CKEDITOR.plugins.add(CKEditorPluginUtility.Plugins[pluginName].Setting.SingleName, {
            init: function (editor) {
                ...
                function addToEditor(ckEditor, pluginSetting, props, contentWindow) {
                    ...
                    var tip = "简单查询区域[双击编辑该部件],在下边div中编辑查询内容";
