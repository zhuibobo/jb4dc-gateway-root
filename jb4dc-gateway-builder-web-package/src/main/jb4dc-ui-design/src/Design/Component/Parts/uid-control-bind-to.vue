...
export default {
    ...
    methods:{
        ...
        selectBindFieldView:function () {
            ...
            GeneralPlugin.selectBindToSingleFieldDialogBeginProxy(this.getSelectFieldResultValue(),this);
        },
        ...
        selectValidateRuleView:function () {
            ...
            GeneralPlugin.selectValidateRuleDialogBeginProxy(this.getSelectValidateRuleResultValue(),this);
        },
