<template>
    <table cellpadding="0" cellspacing="0" border="0" class="html-design-plugin-dialog-table-wraper">
        ...
        <tr>
            ...
            <td>
                <a-select v-model:value="bindToSearchField.columnOperator" style="width:240px">
                    <a-select-option value="eq">等于</a-select-option>
                    <a-select-option value="like">匹配</a-select-option>
                    <a-select-option value="not_eq">不等于</a-select-option>
                    <a-select-option value="gt">大于</a-select-option>
                    <a-select-option value="gt_eq">大于等于</a-select-option>
                    <a-select-option value="lt">小于</a-select-option>
                    <a-select-option value="lt_eq">小于等于</a-select-option>
                    <a-select-option value="left_like">左匹配</a-select-option>
                    <a-select-option value="right_like">右匹配</a-select-option>
                    <a-select-option value="include">包含[暂时不支持]</a-select-option>
                </a-select>
            </td>
        </tr>
        <tr>
...
export default {
    name: "list-search-control-bind-to-comp",
    ...
    methods:{
        init:function(dataSetPO){
            ...
            fuzzySearchTreeObj(this.tree.treeObj,this.$refs.txt_search_text.input,null,true);
        },
