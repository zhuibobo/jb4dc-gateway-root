<template>
    <table cellpadding="0" cellspacing="0" border="0" class="html-design-plugin-dialog-table-wraper">
        ...
        <tr>
            ...
            <td>
                <a-select v-model:value="bindProp.columnAlign" style="width:260px">
                    <a-select-option value="左对齐">左对齐</a-select-option>
                    <a-select-option value="居中对齐">居中对齐</a-select-option>
                    <a-select-option value="右对齐">右对齐</a-select-option>
                </a-select>
            </td>
        ...
        <tr>
            ...
            <td>
                <a-select v-model:value="bindProp.targetButtonId" style="width:260px" :clearable="true">
...
<script>
export default {
    name: "list-table-label-bind-to-comp",
