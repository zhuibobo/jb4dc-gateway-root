    ...
    <div class="uid-wysiwyg-comp-root">
        ...
        <div>
            <div id="uid-wysiwyg-plugin-list-comp-wrap" style="font-size: 0.8125em">
                ...
                <h3>动态控件</h3>
                <div class="plugin-list-wrap">
                    <uid-wysiwyg-plugin-list-comp :control-plugins-config="controlPluginsConfig" group-name="DynamicContainer"></uid-wysiwyg-plugin-list-comp>
                </div>
                <h3>模板控件</h3>
                <div class="plugin-list-wrap">
                    <uid-wysiwyg-plugin-list-comp :control-plugins-config="controlPluginsConfig" group-name="TemplateContainer"></uid-wysiwyg-plugin-list-comp>
                </div>
            </div>
        </div>
