        ...
        <div
            ...
            <table class="light-gray-table" cellpadding="0" cellspacing="0" border="0"
                ...
                <tr v-if="relationTableEditorView.isSubEditTr">
                    ...
                    <td>
                        <a-radio-group v-model:value="currentEditorData.relationType" type="button" size="small">
                            <a-radio-button value="1To1">1:1</a-radio-button>
                            <a-radio-button value="1ToN">1:N</a-radio-button>
                        </a-radio-group>
                    </td>
                    <td class="label">是否保存：</td>
                    <td>
                        <a-radio-group v-model:value="currentEditorData.isSave" type="button" size="small">
