<template>
    <div id="uid-css-code-editor-comp-root"></div>
</template>
...
export default {
    ...
    methods:{
        getValue(){
            return  MonacoEditorUtility.getValue(window.uidCssCodeMonacoEditor);
        },
        setValue(value) {
            //console.log(value);
            if(value) {
                MonacoEditorUtility.setValue(window.uidCssCodeMonacoEditor, value);
            }
        }
    }
}
