    ...
    <div style="width: 1224px;margin: auto">
        <a-tabs tab-position="left">
            <a-tab-pane key="tab-base-info" tab="基础设置">
                <div
                    style="width: 500px;height: 610px;border: #ddddf1 1px solid;border-radius: 4px;padding: 10px 20px 10px 10px;float: left">
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" class="form-table">
                        ...
                        <tr>
                            <td>数据集主键字段：</td>
                            <td>
                                <a-input v-model:value="listResourceEntity.listDatasetPrimaryKey"
                                         placeholder=""></a-input>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <a-radio-group type="button" style="margin: auto"
                                               v-model:value="listResourceEntity.listEveryTimeResolve">
                        ...
                        <tr>
                            <td>主题：</td>
                            <td>
                                <a-select v-model:value="listResourceEntity.listTheme" @change="changeTheme"
                                          style="width: 180px">
                        ...
                        <tr>
                            <td>备注：</td>
                            <td>
                                <a-textarea v-model:value="listResourceEntity.listDesc" type="textarea"
                                            :autoSize="{minRows: 12,maxRows: 12}"></a-textarea>
                            </td>
                        </tr>
                        </tbody>
                    </table>
                ...
                <div
                    style="width: 590px;height: 610px;border: #ddddf1 1px solid;border-radius: 4px;padding: 10px 20px 10px 10px;float: right">
            ...
            <a-tab-pane key="tab-extend-config" tab="扩展设置">
                <div
                    style="width: 1100px;height: 615px;border: #ddddf1 1px solid;border-radius: 4px;padding: 10px 20px 10px 10px;">
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" class="form-table">
                        ...
                        <tr>
                            <td>服务端渲染方法：</td>
                            <td>
                                <a-input v-model:value="listResourceEntity.listCustServerRenderer"
                                         placeholder="服务端自定义的渲染方法:继承IFormSeverRenderer"></a-input>
                            </td>
                        </tr>
                        <tr>
                            <td>客户端渲染方法：</td>
                            <td>
                                <a-input v-model:value="listResourceEntity.listCustClientRenderer"
                                         placeholder="客户端自定义的渲染方法:需要指明具体的方法名称"></a-input>
                            </td>
                        </tr>
                        <tr>
                            <td>引入JS：</td>
                            <td>
                                <a-textarea v-model:value="listResourceEntity.listCustRefJs" placeholder="引入的脚本:多个通过;分割"
                                            type="textarea" :autosize="{minRows: 4,maxRows: 4}"></a-textarea>
                            </td>
                        </tr>
                        <tr>
                            <td>备注：</td>
                            <td>
                                <a-textarea v-model:value="listResourceEntity.listCustDesc" type="textarea"
                                            :autosize="{minRows: 18,maxRows: 18}"></a-textarea>
                            </td>
                        </tr>
                        </tbody>
                    </table>
...
export default {
    ...
    methods: {
        ...
        save(editorValues, successFun) {
            ...
            RemoteRestInterface.saveWebListDesign(this.listResourceEntity).then((response) => {
