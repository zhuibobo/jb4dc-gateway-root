        ...
        <a-tabs tab-position="top" size="small" type="card">
            <a-tab-pane key="bindInfo" tab="绑定信息">
                <div style="width: 868px;margin: auto">
                    <div
                        style="width: 350px;height: 594px;border: #ddddf1 1px solid;border-radius: 4px;padding: 10px 20px 10px 10px;float: left">
                        <a-divider orientation="left" style="font-size: 12px">参数设置</a-divider>
                        <table cellpadding="0" cellspacing="0" border="0"
                               class="html-design-plugin-dialog-table-wraper">
                            <colgroup>
                            ...
                            <tr>
                                <td>条件：</td>
                                <td>
                                    <a-textarea v-model:value="normalProps.condition" type="textarea"
                            ...
                            <tr>
                                <td>备注：</td>
                                <td>
                                    <a-textarea v-model:value="normalProps.desc" type="textarea"
                                                :autoSize="{minRows: 13,maxRows: 13}"></a-textarea>
                                </td>
                            </tr>
                            </tbody>
                        </table>
                    ...
                    <div
                        style="width: 506px;height: 594px;border: #ddddf1 1px solid;border-radius: 4px;padding: 10px 20px 10px 10px;float: right">
            ...
            <a-tab-pane key="devExtend" tab="开发扩展">
                <table cellpadding="0" cellspacing="0" border="0" class="html-design-plugin-dialog-table-wraper">
                    ...
                    <tr>
                        ...
                        <td>
                            <a-input v-model:value="normalProps.custServerGetDataAPI"
                                     placeholder="为该部件提供数据的API,需要实现接口IListLayoutContainerCustDataSource"></a-input>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <a-input v-model:value="normalProps.custServerGetDataAPIPara"
                                     placeholder="服务端数据API的相关参数"></a-input>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <a-input v-model:value="normalProps.custClientResolveDataMethod"
                                     placeholder="数据加载到客户端之后,将经过该方法进行一次处理"></a-input>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <a-input v-model:value="normalProps.custClientResolveDataMethodPara"
                                     placeholder="客户端数据处理方法的相关参数"></a-input>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <a-input v-model:value="normalProps.custServerResolveMethod"
                                     placeholder="服务端解析,保存模版时候调用一次,类全称,需要实现接口IListLayoutContainerCustResolve"></a-input>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <a-input v-model:value="normalProps.custServerResolveMethodPara"
                                     placeholder="服务端解析类的相关参数"></a-input>
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <a-input v-model:value="normalProps.custClientRendererMethodPara"
                                     placeholder="客户端渲染方法的相关参数"></a-input>
                        </td>
                    </tr>
                    </tbody>
                </table>
