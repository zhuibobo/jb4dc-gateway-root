            ...
            <a-tab-pane key="bindInfo" tab="绑定信息">
                <table class="html-design-plugin-dialog-table-wraper" cellpadding="0" cellspacing="0" border="0">
                    ...
                    <tr>
                        <td>触发按钮：</td>
                        <td>
                            <a-select v-model:value="normalProps.targetButtonId" style="width:230px" :clearable="true" @change="changeTargetButton">
                                <a-select-option :value="item.buttonId" v-for="item in buttons">{{item.buttonCaption}}</a-select-option>
                            </a-select>
                        </td>
                        <td>标题：</td>
                        <td colspan="3">
                    ...
                    <tr>
                        ...
                        <td colspan="5">
                            <div class="wldct-list-table-row-button-wrap ">
                                ...
                                <div class="wldct-list-table-row-inner-button listmanager" @click="changeSelectedClass('listmanager')"></div>
                                <div class="wldct-list-table-row-inner-button edit-model" @click="changeSelectedClass('edit-model')"></div>
                                <div class="wldct-list-table-row-inner-button view-model" @click="changeSelectedClass('view-model')"></div>
                                <div class="wldct-list-table-row-inner-button move-up" @click="changeSelectedClass('move-up')"></div>
                                <div class="wldct-list-table-row-inner-button move-down" @click="changeSelectedClass('move-down')"></div>
                                ...
                                <div class="wldct-list-table-row-inner-button image-cultured" @click="changeSelectedClass('image-cultured')"></div>
                                <div class="wldct-list-table-row-inner-button page-white-edit" @click="changeSelectedClass('page-white-edit')"></div>
                                <div class="wldct-list-table-row-inner-button page-attach" @click="changeSelectedClass('page-attach')"></div>
                                <div class="wldct-list-table-row-inner-button page-go" @click="changeSelectedClass('page-go')"></div>
                                <div class="wldct-list-table-row-inner-button script-key" @click="changeSelectedClass('script-key')"></div>
                                <div class="wldct-list-table-row-inner-button wrench-orange" @click="changeSelectedClass('wrench-orange')"></div>
                                <div class="wldct-list-table-row-inner-button x-office-document-template" @click="changeSelectedClass('x-office-document-template')"></div>
                                <div class="wldct-list-table-row-inner-button x-office-drawing" @click="changeSelectedClass('x-office-drawing')"></div>
                                <div class="wldct-list-table-row-inner-button kjobviewer" @click="changeSelectedClass('kjobviewer')"></div>
                            </div>
                        </td>
                    </tr>
                    <tr>
