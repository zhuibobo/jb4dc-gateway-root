<template>
    <div>
        ...
        <i-table border :columns="addedMessageConfig" :data="addedMessageData"
                 class="iv-list-table" size="small" no-data-text="add Message" height="420">
            <template slot-scope="{ row, index }" slot="action">
                <div class="wf-list-font-icon-button-class" @click="deleteMessage(index,row)">
                    <Icon type="md-close" />
                </div>
            </template>
        </i-table>
        <div id="addMessagesDialog" style="display: none">
            <div>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div style="margin-top: 8px">
                                <tag type="border" color="success">Id使用Message_前缀,英文</tag>
                            </div>
                        </td>
                    </tr>
                    <tr>
...
export default {
    ...
    props:["propMessagePropertiesData"],
    data(){
        return {
            innerDetailInfo:{
                id:"",
    ...
    mounted(){
        this.addedMessageData=this.propMessagePropertiesData;
        //console.log(this.addedListenerData);
    },
    methods:{
        showAddDialog(){
            var dialogElemId="addMessagesDialog";
            var _self=this;
            this.innerDetailInfo.id="Message_"+StringUtility.Timestamp();
        ...
        deleteMessage:function (index,row) {
            this.addedMessageData.splice(index, 1);
        }
    }
}
</script>
